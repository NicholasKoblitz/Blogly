...
jane_smith = User(first_name="Jane", last_name="Smith",
                  image_url="https://image.shutterstock.com/image-photo/closeup-portrait-yong-woman-casual-260nw-1554086789.jpg")
mike_johnson = User(first_name="Mike", last_name="Johnson",
...
post_3 = Post(title="First Post",
              content="Hello, this is my first post. How are you all?", user_id=3)
post_4 = Post(title="Life Update", content="All is going GOOD!!", user_id=1)
post_5 = Post(title="Workers Needed!",
              content="If you want to work call me", user_id=4)
